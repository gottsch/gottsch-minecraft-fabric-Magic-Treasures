...
//            getOrCreateTagBuilder(MagicTreasuresTags.Items.JEWELRY).add(MagicTreasuresItems.ADEPHAGIAS_BOUNTY);
            ...
            // ingots
            getOrCreateTagBuilder(MagicTreasuresTags.Items.INGOTS_SILVER).add(MagicTreasuresItems.SILVER_INGOT);

            // raw materials
            getOrCreateTagBuilder(MagicTreasuresTags.Items.RAW_SILVER).add(MagicTreasuresItems.RAW_SILVER);
            getOrCreateTagBuilder(MagicTreasuresTags.Items.BONES).add(Items.BONE);
